...
function updateWeatherUI(data) {
  ...
  weatherIcon.src = `https://lucmania.github.io/WeatherNow/img_apiclima/${mappedIconCode}.png`;
...
function createWeatherSummary(temp, openWeatherIcon, description) {
  ...
  weatherSummary.innerHTML = `
    <div class="weather-summary-card">
      ...
      <img class="summary-icon" src="https://lucmania.github.io/WeatherNow/img_apiclima/${mappedIconCode}.png" alt="${description}" />
    </div>
  `;
}
